  ...
  return (
    ...
    <Navbar/>
        <div className="container text-center mx-auto px-6 py-6 text-white md:px-20 lg:px-32">
            ...
            viewport={{once: true}} 
            className="text-5xl sm:text-6xl md:text-[80px] inline-block max-w-3xl font-semibold py-20">
              Explore Your Homes That Fits Your Dreams
            </motion.h2>
            <motion.div
            ...
            whileInView={{opacity: 1, y:  0 }}
            viewport={{once: false}}
            className="space-x-6 mt-16 text-lg">
