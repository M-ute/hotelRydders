    ...
    <Navbar/>
        <div className="container text-center mx-auto px-6 py-6 text-white md:px-20 lg:px-32">
            ...
            <div className="space-x-6 mt-16 text-lg">
                <a href="" className="border-3 rounded-4xl border-white px-8 py-4 text-green-400 hover:bg-amber-50">Projects</a>
                <a href="" className="bg-white rounded-4xl px-8 py-4 text-amber-500 hover:bg-amber-50">Contacts Us</a>
            </div>
        </div>
