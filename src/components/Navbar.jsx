  ...
  return (
    <div className="absolute top-0 left-0 w-full z-0">
        ...
        <div className={`md:hidden ${showMobileMenu ? 'fixed w-full' : 'hidden'} top-0 right-0 bottom-0 overflow-hidden
          transition-all`}>
            <div className="flex justify-end cursor-pointer px-3 py-5 bg-white ">
            ...
            font-medium px-5 py-1 bg-white ">
                ...
                <a href="#Header" className=" px-4 py-2 rounded-full inline-block">Services</a>
                <a href="#Header" className=" px-4 py-2 rounded-full inline-block">Contact</a>
                <a href="#Header" className=" px-4 py-2 rounded-full inline-block">Testimonials</a>
